...
const (
	CloseType_UNDEFINED_CT CloseType = 0 // 默认值 未关闭
...
const (
	CalculateType_ADD_AMOUNT CalculateType = 0 // 增加需要支付的金额
	CalculateType_SUB_AMOUNT CalculateType = 1 // 减少需要支付的金额
)

// Enum value maps for CalculateType.
var (
	CalculateType_name = map[int32]string{
		0: "ADD_AMOUNT",
		1: "SUB_AMOUNT",
	}
	CalculateType_value = map[string]int32{
		"ADD_AMOUNT": 0,
		"SUB_AMOUNT": 1,
	}
)

func (x CalculateType) Enum() *CalculateType {
	p := new(CalculateType)
	*p = x
	return p
}

func (x CalculateType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CalculateType) Descriptor() protoreflect.EnumDescriptor {
	return file_trade_entities_proto_enumTypes[14].Descriptor()
}

func (CalculateType) Type() protoreflect.EnumType {
	return &file_trade_entities_proto_enumTypes[14]
}

func (x CalculateType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CalculateType.Descriptor instead.
func (CalculateType) EnumDescriptor() ([]byte, []int) {
...
func (RefundOrderStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_trade_entities_proto_enumTypes[17].Descriptor()
}

func (RefundOrderStatus) Type() protoreflect.EnumType {
	return &file_trade_entities_proto_enumTypes[17]
}
...
func (RefundOrderStatus) EnumDescriptor() ([]byte, []int) {
	return file_trade_entities_proto_rawDescGZIP(), []int{17}
}
...
type FeeInfo struct {
	...
	Id            int64             `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`                                                                                              // 费用明细id
	OrderId       int64             `protobuf:"varint,2,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`                                                                     // 所属交易单id
	CalculateType CalculateType     `protobuf:"varint,3,opt,name=calculate_type,json=calculateType,proto3,enum=api.CalculateType" json:"calculate_type,omitempty"`                            // 计算类型
	Name          string            `protobuf:"bytes,4,opt,name=name,proto3" json:"name,omitempty"`                                                                                           // 费用名称
	Description   string            `protobuf:"bytes,5,opt,name=description,proto3" json:"description,omitempty"`                                                                             // 费用描述
	Amount        uint64            `protobuf:"varint,6,opt,name=amount,proto3" json:"amount,omitempty"`                                                                                      // 费用金额 单位：厘
	Extra         map[string]string `protobuf:"bytes,7,rep,name=extra,proto3" json:"extra,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 额外信息
...
func (x *FeeInfo) GetOrderId() int64 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
func (x *FeeInfo) GetCalculateType() CalculateType {
	if x != nil {
...
func (x *FeeInfo) GetDescription() string {
	if x != nil {
...
func (x *FeeInfo) GetExtra() map[string]string {
	if x != nil {
		return x.Extra
	}
	return nil
...
func (x *FeeInfo) GetCreateTime() int64 {
	if x != nil {
		return x.CreateTime
	}
	return 0
...
func (x *FeeInfo) GetUpdateTime() int64 {
	if x != nil {
		return x.UpdateTime
	}
	return 0
...
type TradeOrder struct {
	...
	Payments           []*FeeInfo           `protobuf:"bytes,26,rep,name=payments,proto3" json:"payments,omitempty"`                                                                                   // 支付信息
...
func (x *TradeOrder) GetPayments() []*FeeInfo {
	if x != nil {
		return x.Payments
	}
	return nil
...
var file_trade_entities_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x82, 0x02, 0x0a, 0x0e,
	...
	,
	...
	0x69, 0x6c, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x72, 0x65, 0x63, 0x65, 0x69,
	0x76, 0x65, 0x72, 0x4d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x12, 0x29, 0x0a, 0x10, 0x72, 0x65, 0x63,
	...
	0x72, 0x65, 0x73, 0x73, 0x12, 0x32, 0x0a, 0x05, 0x65, 0x78, 0x74, 0x72, 0x61, 0x18, 0x08, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65,
	0x72, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x45, 0x78, 0x74, 0x72, 0x61, 0x45, 0x6e, 0x74, 0x72,
	...
	,
	...
	0x65, 0x72, 0x49, 0x64, 0x12, 0x39, 0x0a, 0x0e, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74,
	0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x12, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x65, 0x54, 0x79, 0x70, 0x65,
	0x52, 0x0d, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x06, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x2d, 0x0a,
	0x05, 0x65, 0x78, 0x74, 0x72, 0x61, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x46, 0x65, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x45, 0x78, 0x74, 0x72, 0x61,
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x05, 0x65, 0x78, 0x74, 0x72, 0x61, 0x12, 0x1f, 0x0a, 0x0b,
	...
	,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x72, 0x65, 0x66, 0x75, 0x6e, 0x64, 0x41, 0x6d,
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x65, 0x66, 0x75, 0x6e, 0x64, 0x5f, 0x74,
	0x69, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x72, 0x65, 0x66, 0x75, 0x6e,
	...
	,
	...
	,
...
var file_trade_entities_proto_enumTypes = make([]protoimpl.EnumInfo, 18)
var file_trade_entities_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_trade_entities_proto_goTypes = []interface{}{
	...
	(CalculateType)(0),        // 14: api.CalculateType
	(TradeOrderRelation)(0),   // 15: api.TradeOrderRelation
	(RefundOrderType)(0),      // 16: api.RefundOrderType
	(RefundOrderStatus)(0),    // 17: api.RefundOrderStatus
	(*TradeParticipant)(nil),  // 18: api.TradeParticipant
	(*TradePromotion)(nil),    // 19: api.TradePromotion
	(*DeliveryInfo)(nil),      // 20: api.DeliveryInfo
	(*TimeoutInfo)(nil),       // 21: api.TimeoutInfo
	(*FeeInfo)(nil),           // 22: api.FeeInfo
	(*RefundOrder)(nil),       // 23: api.RefundOrder
	(*TradeOrder)(nil),        // 24: api.TradeOrder
	nil,                       // 25: api.DeliveryInfo.ExtraEntry
	nil,                       // 26: api.FeeInfo.ExtraEntry
	nil,                       // 27: api.TradeOrder.ExtraEntry
}
var file_trade_entities_proto_depIdxs = []int32{
	...
	25, // 3: api.DeliveryInfo.extra:type_name -> api.DeliveryInfo.ExtraEntry
	14, // 4: api.FeeInfo.calculate_type:type_name -> api.CalculateType
	26, // 5: api.FeeInfo.extra:type_name -> api.FeeInfo.ExtraEntry
	16, // 6: api.RefundOrder.refund_type:type_name -> api.RefundOrderType
	17, // 7: api.RefundOrder.refund_status:type_name -> api.RefundOrderStatus
	0,  // 8: api.TradeOrder.biz_type:type_name -> api.TradeBizType
	1,  // 9: api.TradeOrder.sale_way:type_name -> api.TradeSaleWay
	2,  // 10: api.TradeOrder.pay_sequence:type_name -> api.TradePaySequence
	3,  // 11: api.TradeOrder.goods_type:type_name -> api.TradeGoodsType
	4,  // 12: api.TradeOrder.order_status:type_name -> api.TradeOrderStatusEnum
	18, // 13: api.TradeOrder.buyer:type_name -> api.TradeParticipant
	18, // 14: api.TradeOrder.seller:type_name -> api.TradeParticipant
	5,  // 15: api.TradeOrder.pay_type:type_name -> api.PayType
	19, // 16: api.TradeOrder.promotions:type_name -> api.TradePromotion
	20, // 17: api.TradeOrder.delivery_info:type_name -> api.DeliveryInfo
	21, // 18: api.TradeOrder.timeout_info:type_name -> api.TimeoutInfo
	9,  // 19: api.TradeOrder.close_type:type_name -> api.CloseType
	24, // 20: api.TradeOrder.sub_order:type_name -> api.TradeOrder
	22, // 21: api.TradeOrder.payments:type_name -> api.FeeInfo
	27, // 22: api.TradeOrder.extra:type_name -> api.TradeOrder.ExtraEntry
	15, // 23: api.TradeOrder.trade_order_relation:type_name -> api.TradeOrderRelation
	23, // 24: api.TradeOrder.refunds:type_name -> api.RefundOrder
